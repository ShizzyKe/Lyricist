...
import java.util.HashMap;
    ...
    public class PrefUtils {
        ...
        private static final String KEY_REGISTRATION_ID_SAVED_TO_SERVER = "save_registration_id_to_server";
        ...
        public boolean isRegistrationIdSentToServer() {
            return sharedPreferencesCompat.getBoolean(KEY_REGISTRATION_ID_SAVED_TO_SERVER, false);
        }

        public void markRegistrationIdSentToServer(boolean isSentToServer) {
            editor.putBoolean(KEY_REGISTRATION_ID_SAVED_TO_SERVER, isSentToServer);
            editor.commit();
        }
